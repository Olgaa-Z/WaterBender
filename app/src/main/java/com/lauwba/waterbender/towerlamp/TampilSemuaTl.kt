...
class TampilSemuaTl : AppCompatActivity(), AdapterView.OnItemClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tampil_semua_tl)
    ...
    private fun showEmployee() {
        ...
        val adapter = SimpleAdapter(
            this@TampilSemuaTl, list, R.layout.list_item,
